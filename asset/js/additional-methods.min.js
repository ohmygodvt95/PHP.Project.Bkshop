...
! function(a) {
	...
	! function() {
		...
		var d, e = "string" == typeof c,
			f = e ? c : c[0],
			g = e ? !0 : c[1];
		return f = f["replace"](/,/g, ""), f = g ? f + "]" : f + "]?", d = "^[" + f + "([1-9]{1}[0-9]{0,2}(\x5C,[0-9]{3})*(\x5C.[0-9]{0,2})?|[1-9]{1}[0-9]{0,}(\x5C.[0-9]{0,2})?|0(\x5C.[0-9]{0,2})?|(\x5C.[0-9]{1,2})?)$", d = new RegExp(d), this["optional"](b) || d["test"](a);
		...
		if (c = l["substring"](0, 2), h = {
			AL: "\x5Cd{8}[\x5CdA-Z]{16}",
			AD: "\x5Cd{8}[\x5CdA-Z]{12}",
			AT: "\x5Cd{16}",
			AZ: "[\x5CdA-Z]{4}\x5Cd{20}",
			BE: "\x5Cd{12}",
			BH: "[A-Z]{4}[\x5CdA-Z]{14}",
			BA: "\x5Cd{16}",
			BR: "\x5Cd{23}[A-Z][\x5CdA-Z]",
			BG: "[A-Z]{4}\x5Cd{6}[\x5CdA-Z]{8}",
			CR: "\x5Cd{17}",
			HR: "\x5Cd{17}",
			CY: "\x5Cd{8}[\x5CdA-Z]{16}",
			CZ: "\x5Cd{20}",
			DK: "\x5Cd{14}",
			DO: "[A-Z]{4}\x5Cd{20}",
			EE: "\x5Cd{16}",
			FO: "\x5Cd{14}",
			FI: "\x5Cd{14}",
			FR: "\x5Cd{10}[\x5CdA-Z]{11}\x5Cd{2}",
			GE: "[\x5CdA-Z]{2}\x5Cd{16}",
			DE: "\x5Cd{18}",
			GI: "[A-Z]{4}[\x5CdA-Z]{15}",
			GR: "\x5Cd{7}[\x5CdA-Z]{16}",
			GL: "\x5Cd{14}",
			GT: "[\x5CdA-Z]{4}[\x5CdA-Z]{20}",
			HU: "\x5Cd{24}",
			IS: "\x5Cd{22}",
			IE: "[\x5CdA-Z]{4}\x5Cd{14}",
			IL: "\x5Cd{19}",
			IT: "[A-Z]\x5Cd{10}[\x5CdA-Z]{12}",
			KZ: "\x5Cd{3}[\x5CdA-Z]{13}",
			KW: "[A-Z]{4}[\x5CdA-Z]{22}",
			LV: "[A-Z]{4}[\x5CdA-Z]{13}",
			LB: "\x5Cd{4}[\x5CdA-Z]{20}",
			LI: "\x5Cd{5}[\x5CdA-Z]{12}",
			LT: "\x5Cd{16}",
			LU: "\x5Cd{3}[\x5CdA-Z]{13}",
			MK: "\x5Cd{3}[\x5CdA-Z]{10}\x5Cd{2}",
			MT: "[A-Z]{4}\x5Cd{5}[\x5CdA-Z]{18}",
			MR: "\x5Cd{23}",
			MU: "[A-Z]{4}\x5Cd{19}[A-Z]{3}",
			MC: "\x5Cd{10}[\x5CdA-Z]{11}\x5Cd{2}",
			MD: "[\x5CdA-Z]{2}\x5Cd{18}",
			ME: "\x5Cd{18}",
			NL: "[A-Z]{4}\x5Cd{10}",
			NO: "\x5Cd{11}",
			PK: "[\x5CdA-Z]{4}\x5Cd{16}",
			PS: "[\x5CdA-Z]{4}\x5Cd{21}",
			PL: "\x5Cd{24}",
			PT: "\x5Cd{21}",
			RO: "[A-Z]{4}[\x5CdA-Z]{16}",
			SM: "[A-Z]\x5Cd{10}[\x5CdA-Z]{12}",
			SA: "\x5Cd{2}[\x5CdA-Z]{18}",
			RS: "\x5Cd{18}",
			SK: "\x5Cd{20}",
			SI: "\x5Cd{15}",
			ES: "\x5Cd{20}",
			SE: "\x5Cd{20}",
			CH: "\x5Cd{5}[\x5CdA-Z]{12}",
			TN: "\x5Cd{20}",
			TR: "\x5Cd{5}[\x5CdA-Z]{17}",
			AE: "\x5Cd{3}\x5Cd{16}",
			GB: "[A-Z]{4}\x5Cd{14}",
			VG: "[\x5CdA-Z]{4}\x5Cd{16}"
		}, g = h[c], "undefined" != typeof g && (i = new RegExp("^[A-Z]{2}\x5Cd{2}" + g + "$", ""), !i["test"](l))) {
			return !1
		};
	...
	}, "Please specify a valid uk phone number"), $["validator"]["addMethod"]("phonesVN", function(phone_number, element) {
		phone_number = phone_number["replace"](/\(|\)|\s+|-/g, "");
		return this["optional"](element) || phone_number["length"] > 9 && phone_number["match"](/^[0]{1}[19]{1}[0-9]{8,9}$/);
	}, "Xin hãy nhập đúng định dạng số điện thoại di động");

$["validator"]["addMethod"]("VNcmt", function(phone_number, element) {
		phone_number = phone_number["replace"](/\(|\)|\s+|-/g, "");
		return this["optional"](element) || phone_number["length"] > 8 && phone_number["match"](/^[0-9]{9}$/);
	}, "Xin hãy nhập đúng định dạng số CMTND");
