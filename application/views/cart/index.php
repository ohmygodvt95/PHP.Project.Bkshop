            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <hr>
                        <a href="<?php echo site_url();?>cart/pay/" class="btn btn-danger btn-lg btn-block <?php if($total == 0) echo "active";?>" style="<?php if($total == 0) echo "opacity:0.3!important";?>">Thanh toán ngay <i class="fa fa-fw fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
