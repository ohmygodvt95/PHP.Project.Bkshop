...
<html>
    <head>
        ...
        <meta name="description" content="<?php echo COMPANY;?> - <?php echo SOLOGAN;?> - ">
        ...
        <meta itemprop="description" content="<?php echo COMPANY;?> - <?php echo SOLOGAN;?> - <?php echo $category->category_title. " - " . $this_category->category_title;?>">
        <meta itemprop="image" content="<?php echo base_url();?>asset/images/logo2.png">
        <meta property="og:title" content="<?php echo COMPANY;?> - <?php echo SOLOGAN;?> - <?php echo $category->category_title. " - " . $this_category->category_title;?>" />
        <meta property="og:locale" content="vi_VN" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="<?php echo $_SERVER['REQUEST_URI'];?>" />
        <meta property="og:image" content="<?php echo base_url();?>asset/images/logo2.png" />
        <meta property="og:description" content="<?php echo COMPANY;?> - <?php echo SOLOGAN;?> - <?php echo $category->category_title. " - " . $this_category->category_title;?>" />
